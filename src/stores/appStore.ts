...
export const useAppStore = create<AppState>()(
  subscribeWithSelector((set, get) => ({
    ...
    setAdbExecutablePath: (path) => set({ adbExecutablePath: path.trim() }),
    ...
    importConfig: (config) => {
      ...
      set({
        ...
        adbExecutablePath: config.settings.adbExecutablePath ?? '',
...
function generateConfig(): MxuConfig {
  ...
  return {
    ...
    settings: {
      ...
      adbExecutablePath: state.adbExecutablePath || undefined,
...
useAppStore.subscribe(
  (state) => ({
    ...
    accentColor: state.accentColor,
    language: state.language,
    adbExecutablePath: state.adbExecutablePath,
    confirmBeforeDelete: state.confirmBeforeDelete,
    maxLogsPerInstance: state.maxLogsPerInstance,
    windowSize: state.windowSize,
    windowPosition: state.windowPosition,
